			...
			<div class="container">
				<div class="signin-content">
					...
					<div class="signin-form">
						<h2 class="form-title">Average Scores for All Student</h2>
						<form action="DisplayForAllStudentsServlet" method="Post">
							
							<div class="form-group">
								 Enter Subject Name: <input type="text" name="subjectname" id="subjectname" placeholder="Enter Subject Name" />
							</div>
